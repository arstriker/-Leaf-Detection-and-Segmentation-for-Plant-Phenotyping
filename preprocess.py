...
def extract_features(image, mask, gray_image=None, lbp=None):
    ...
    # Support both new and old properties of skimage.measure._regionprops
    try:
    ...
    # This avoids cv2.bitwise_and, which allocates an unnecessary full-size intermediate array.
    valid_mask = mask > 0
