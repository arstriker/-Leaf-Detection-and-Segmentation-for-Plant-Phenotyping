...
def extract_features(image, mask, gray_image=None, lbp=None):
    ...
    # Performance optimization: Direct boolean indexing avoids
    # allocating a full-size intermediate array with cv2.bitwise_and,
    # significantly reducing memory overhead and CPU cycles.
