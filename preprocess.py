...
def extract_features(image, mask, gray_image=None, lbp=None):
    ...
    # Performance optimization: Use direct boolean indexing instead of allocating
    # a full-size intermediate array with cv2.bitwise_and, saving memory and CPU cycles.
    pixels = image[mask > 0]
