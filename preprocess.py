...
def extract_features(image, mask, gray_image=None, lbp=None):
    ...
    # ⚡ Bolt Optimization: Use direct boolean indexing instead of allocating
    # a full-size intermediate image array with cv2.bitwise_and.
    # This prevents redundant memory allocations and repeated mask evaluations.
    valid_mask = mask > 0
