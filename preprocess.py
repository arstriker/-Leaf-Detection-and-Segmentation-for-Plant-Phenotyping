...
def extract_features(image, mask, gray_image=None, lbp=None):
    ...
    # ⚡ Bolt Optimization: Use direct boolean indexing instead of full-sized array allocations (cv2.bitwise_and)
    # This prevents creating a massive intermediate image array and evaluating the mask condition three separate times.
    # It dramatically reduces memory usage and improves feature extraction latency.
    valid_mask = mask > 0
