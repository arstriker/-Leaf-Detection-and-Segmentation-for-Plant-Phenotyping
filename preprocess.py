...
def extract_features(image, mask, gray_image=None, lbp=None):
    ...
    # Bolt Optimization: Avoid redundant full-array allocation with cv2.bitwise_and
    # and multiple array boolean indexing evaluations. Instead, index once directly
    # into the image. This saves memory and significantly reduces CPU cycles.
    valid_mask = mask > 0
