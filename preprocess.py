...
def extract_features(image, mask, gray_image=None, lbp=None):
    ...
    # Avoiding cv2.bitwise_and prevents allocating a full-size intermediate NumPy array,
    # which measurably reduces memory footprint and CPU overhead, especially on high-res images.
    valid_mask = mask > 0
