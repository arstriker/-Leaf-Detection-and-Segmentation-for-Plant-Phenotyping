...
def extract_features(image, mask, gray_image=None, lbp=None):
    ...
    # ⚡ Bolt Optimization: Use direct boolean indexing to avoid the memory overhead and CPU cycles
    # of allocating a full-size intermediate array with cv2.bitwise_and.
    valid_mask = mask > 0
